...
Magnetic resonance imaging (MRI) is a preferential medical imaging modality that is extensively used in clinical applications to image the central nervous system and soft-tissues. The preference for MRI confides in its capacity to acquire high-resolution volumetric images of the same underlying anatomy under a comprehensive set of different tissue contrasts. These tissue contrasts are captured by characterizing pulse sequences, and signals emitted from the tissues are collected in a spatial Frequency domain, namely k-space. The collected k-space signals are then inverse Fourier transformed to produce volumetric images of the given anatomy. Yet, prolonged data acquisitions in MRI inherently limits the quality and diversity of MR images acquired. My research aims to develop multi-contrast MRI synthesis models to recover more diverse set of MR images from less diverse sets and to develop MRI reconstruction and super-resolution models to recover high-quality MR images from lower-quality MR images. 
